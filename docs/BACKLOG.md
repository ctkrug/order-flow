...
- [ ] **1.1 [WOW MOMENT] Drag a slider to size a market order and watch it eat the book**
...
- [ ] **1.2 Wire the WASM matching engine into the site**
...
- [ ] **1.3 Render the order-book ladder with D3**
...
- [ ] **2.1 Bundle real historical order-book snapshot data**
...
- [ ] **2.2 Scrubbable snapshot timeline**
...
- [ ] **3.1 Implement the blueprint/technical visual system**
...
- [ ] **3.3 Synth sound effects with mute toggle**
...
- [ ] **3.4 Responsive layout at phone / tablet / desktop**
...
- [ ] **4.1 Landing framing on the same page**
...
- [ ] **4.2 Static build output for subpath hosting**
...
- [ ] **4.3 Cross-browser & error-state check**
